...
interface OrderHistoryModalContentProps {
  onClose: () => void
}

export function OrderHistoryModalContent({ onClose }: OrderHistoryModalContentProps) {
  ...
  return (
    <div className="bg-primary border border-white/10 rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl">
      ...
      <div className="flex items-center justify-between p-6 border-b border-white/10">
        <div>
          <h2 className="text-2xl font-bold text-heading">Order History</h2>
          <p className="text-body text-sm mt-1">View your purchase history and order status</p>
        </div>
        <button
          onClick={onClose}
