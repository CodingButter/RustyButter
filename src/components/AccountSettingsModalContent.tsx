...
export function AccountSettingsModalContent({ onClose }: AccountSettingsModalContentProps) {
  ...
  return (
    <div className="bg-primary border border-white/10 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl">
      {/* Header */}
      <div className="flex items-center justify-between p-6 border-b border-white/10">
        <div>
          <h2 className="text-2xl font-bold text-heading">Account Settings</h2>
          <p className="text-body text-sm mt-1">Manage your account information and security</p>
        </div>
        <button
          onClick={onClose}
